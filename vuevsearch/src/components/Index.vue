<template>
  <el-row class="container">
        ...
        <div class="header_right">
          <div class="title">
            <el-button
              ...
              v-if="this.$store.state.userInfo.name==='未登录'"
            >登陆</el-button>
            <el-button
              @click="dialogFormRegisterVisible = true"
              v-if="this.$store.state.userInfo.name==='未登录'"
            >注册</el-button>
            <el-button v-if="this.$store.state.userInfo.name!=='未登录'">{{this.$store.state.userInfo.name}}</el-button>
            <el-button
              v-if="this.$store.state.userInfo.name!=='未登录'"
              @click="loginOut"
            >退出</el-button>
    ...
    <el-col
      :span="12"
      style="margin-left: 18%;margin-top: 20%;"
    >
      <el-autocomplete
        style="width: 100%"
        v-model="keyword"
    ...
    <el-dialog
      title="用户注册"
      :visible.sync="dialogFormRegisterVisible"
